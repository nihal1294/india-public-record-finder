...
- `PaddlePaddle/ka_PP-OCRv3_mobile_rec`, revision
  ...
  the citizen search path until it meets the required accuracy bar. The
  current accuracy evidence is 16/30 semantic fields (53.33%), below the 90%
  bar; no OCR output is indexed or shown by the product.
